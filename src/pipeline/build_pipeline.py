...
PIPELINE_STEPS = {
    ...
    "build_master": {
        "module": "src.data.build_master",
        "callable": "build_master",
        "fallback_cmd": [sys.executable, "-m", "src.data.build_master"],
    },
    "clean_master": {
    ...
    "verify": {
        "module": "src.data.verify_master",
        "callable": "run_verification",
        "fallback_cmd": [sys.executable, "-m", "src.data.verify_master"],
    },
    "features": {
        "module": "src.data.feature_engineering",
        "callable": "build_features",
        "fallback_cmd": [sys.executable, "-m", "src.data.feature_engineering"],
    },
    "lock_schema": {
    ...
    "safe_transforms": {
        "module": "src.data.safe_transforms",
        "callable": "main",
        "fallback_cmd": [sys.executable, "-m", "src.data.safe_transforms"],
    },
}
