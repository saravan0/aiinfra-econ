"""
Compute standardized predictor effects from existing per-model summary artifacts.

Design notes:
 - Consumes per-variable summary JSON outputs generated by the modeling pipeline.
 - Computes standardized effect measures for cross-model comparison.
"""
